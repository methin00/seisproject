    ...
    tr: {
        ...
        team: {
            ...
            members: {
                ...
                mehmetZahidGorgec: { about: "Konya doğumlu Mehmet Zahid GÖRGEÇ, Bilgisayar Mühendisliği 3. sınıf öğrencisidir. Yazılıma duyduğu ilgiyi akademik bir temelde geliştirerek yapay zekâ ve kullanıcı odaklı yazılım geliştirme alanlarında çalışmalarını sürdürmektedir. Ekibimizde UI/UX & Digital Experience Specialist olarak görev almakta; dijital platformların daha anlaşılır, erişilebilir ve etkili bir yapıya kavuşmasına katkı sağlamayı hedeflemektedir." },
                ...
                yagmurKarakaya: { about: "SEIS bünyesinde Social Media Executive olarak görev alan Yağmur, topluluğun dijital dünyadaki görünürlüğünü ve etkileşim gücünü artıran stratejik süreçleri yürütmektedir. İçerik üretimi, paylaşım planlaması ve etkileşim yönetimi alanlarında aktif rol üstlenen Yağmur, SEIS’in enerjisini ve vizyonunu dijital platformlara profesyonel bir dille yansıtmaktadır. Temel hedefi, topluluğun iletişim dilini güçlendirerek üyelerle sürdürülebilir ve dinamik bir bağ kurmaktır." },
                ...
                senanurBektas: { about: "Sakarya Üniversitesi İngilizce Mütercim ve Tercümanlık 2. sınıf öğrencisi olan Senanur Bektaş, SEIS bünyesinde Kurumsal İletişim ve Dış İlişkiler Koordinatörü olarak görev yapmaktadır. Akademik yolculuğunu kültürlerarası iletişim disiplinleriyle harmanlayan Bektaş, aynı zamanda yarı zamanlı dil eğitmenliği yaparak profesyonel birikimini güçlendirmektedir. İletişimi sadece bir bilgi aktarımı değil, ortak bir değer yaratma süreci olarak gören Senanur, topluluğun dış iletişim stratejilerini yönetmekte ve vizyoner projeler geliştirmektedir." },
    ...
    en: {
        ...
        team: {
            ...
            members: {
                ...
                mehmetZahidGorgec: { about: "Born in Konya, Mehmet Zahid GÖRGEÇ is a 3rd-year Computer Engineering student. He continues his studies in artificial intelligence and user-oriented software development by developing his interest in software on an academic basis. He serves as a UI/UX & Digital Experience Specialist in our team; he aims to contribute to making digital platforms more understandable, accessible, and effective." },
                ...
                yagmurKarakaya: { about: "Serving as Social Media Executive within SEIS, Yağmur manages strategic processes that increase the community's visibility and interaction power in the digital world. Taking an active role in content creation, sharing planning and interaction management, Yağmur reflects SEIS's energy and vision to digital platforms with a professional language. Her main goal is to strengthen the community's communication language and establish a sustainable and dynamic bond with members." },
                ...
                senanurBektas: { about: "Senanur Bektaş, a 2nd-year English Translation and Interpreting student at Sakarya University, serves as the Corporate Communications and External Relations Coordinator at SEIS. Blending her academic journey with intercultural communication disciplines, she also strengthens her professional experience by working as a part-time language instructor. Viewing communication not just as information transfer but as a process of creating shared value, Senanur manages the community's external communication strategies and develops visionary projects." },
